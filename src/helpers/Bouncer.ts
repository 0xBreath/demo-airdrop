...
export const getNFT = async (
  ...
  accounts.forEach((
      ...
      mint = new anchor.web3.PublicKey(account.account.data["parsed"]["info"]["mint"])
      const ata = account.pubkey.toString()
      console.log(`Ticket ATA: ${ata}`);
      console.log(`Ticket Mint: ${mint}`);
  });
  if (mint) {
    return mint;
